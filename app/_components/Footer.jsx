...
export default function Footer() {
  ...
  <div className="mx-auto max-w-5xl px-4 pt-8 sm:px-6 lg:px-8">
    ...
    <p className="mx-auto my-6 max-w-md text-center leading-relaxed text-gray-500">
    نقدم خدمات طباعة متخصصة وأشغال يدوية متميزة، تدمج بين الإبداع والحرفية لتلبية احتياجات
           العملاء. 
    </p>

    <ul className="flex flex-row-reverse items-center justify-center gap-6 text-sm">
            <li>
