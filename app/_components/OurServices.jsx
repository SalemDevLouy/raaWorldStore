...
{ourServicesData.map((service,index)=>(
  <div key={index}
  className="flex flex-col  items-end text-right rounded-lg border border-gray-100 bg-secondry p-4 shadow-md transition hover:shadow-lg sm:p-6 w-[300px] h-[180px] sm:h-[220px]"
>
